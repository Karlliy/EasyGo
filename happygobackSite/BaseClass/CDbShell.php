...
class CDbShell {
    ...
    public static $host = "94.176.236.26"; //sql server hostname
    public static $user = "root"; // username
    public static $pass = "NE2AQ%Z%Pnm[kw&[{xx."; // password
	public static $db = "8591"; // database
	/*public static $host = "127.0.0.1"; //sql server hostname
    public static $user = "root"; // username
    public static $pass = "12345"; // password
    public static $db = "winonline";*/
	...
	static function query($sqlstr) {
		...
		//mysqli_query(self::$dbh, "SET @@sql_mode = ''"); 
	...
	static function begin() { 
		$null = mysqli_query(self::$dbh, "START TRANSACTION");
		return mysqli_query(self::$dbh, "BEGIN"); 		
	} 

	static function rollback() { 
		return mysqli_query(self::$dbh, "ROLLBACK"); 
	} 

	static function commit() { 
		return mysqli_query(self::$dbh, "COMMIT"); 
	} 
}
